...
export const configurationTools = [
    ...
    },
    {
        ...
        description: "Create a configuration. organizationId, name and configurationTypeId are required. Dates must be ISO8601.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Update a configuration. Provide the id plus any attributes to change. Attributes not provided are left untouched.",
        inputSchema: {
            type: "object",
            properties: {
