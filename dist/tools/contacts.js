...
function contactResource(args, id) {
    ...
    const resource = { type: "contacts", attributes };
    if (id)
        resource.id = id;
...
const contactEmailSchema = {
    type: "array",
    description: "Array of {value, label-name, primary}. label-name typical values: 'Work', 'Home', 'Other'.",
    items: {
        type: "object",
        properties: {
            value: { type: "string" },
...
export const contactTools = [
    ...
    },
    {
        ...
        description: "Create a contact. organizationId and firstName are required. Emails/phones are arrays of {value, label-name, primary}.",
        inputSchema: {
            type: "object",
            properties: {
        ...
        handler: async (args, { client }) => {
            ...
            return client.post(`/organizations/${encodeURIComponent(orgId)}/relationships/contacts`, body);
        },
    },
    {
