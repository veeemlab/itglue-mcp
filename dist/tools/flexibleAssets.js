...
function flexibleAssetResource(args, id) {
    ...
    const resource = { type: "flexible_assets", attributes };
    if (id)
        resource.id = id;
    return { data: resource };
}
export const flexibleAssetTools = [
    {
        name: "itglue_list_flexible_asset_types",
        description: "List flexible asset type definitions (schemas) — the catalog of custom IT documentation asset categories like 'Active Directory', 'Backup', 'SSL Certificate', 'Email Provider', 'LAN Network', 'Licensing'. Call this FIRST to learn what flexible asset categories exist in this IT Glue tenant before searching or creating flexible assets. Returns type ids used as flexibleAssetTypeId in other tools. Synonyms: list FA types, list flexible asset schemas, list flexible asset categories, list custom asset types, list IT Glue asset definitions.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        handler: async (args, { client }) => {
            ...
            return client.get(`/flexible_asset_types/${encodeURIComponent(typeId)}/relationships/flexible_asset_fields`, query);
        },
    },
    {
        name: "itglue_search_flexible_assets",
        description: "Search flexible assets. You must supply filterFlexibleAssetTypeId — IT Glue requires it.",
        inputSchema: {
            type: "object",
            properties: {
                flexibleAssetTypeId: {
    ...
    },
    {
        ...
        description: "Create a flexible asset. Call itglue_list_flexible_asset_fields first to learn the `traits` keys required by the chosen flexible asset type.",
        inputSchema: {
            type: "object",
            properties: {
                ...
                traits: {
                    type: "object",
                    description: "Dynamic field values, keyed by the flexible asset type's field keys. Shape varies per type — fetch fields first.",
    ...
    },
    {
        ...
        description: "Update a flexible asset. Provide the id plus the traits you want to change; other trait keys remain untouched.",
        inputSchema: {
            type: "object",
            properties: {
