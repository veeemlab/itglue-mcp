...
export const userTools = [
    {
        ...
        description: "List IT Glue users (people with login access — distinct from contacts). May require admin permissions on the API key. Supports filter[name], filter[email], filter[role_name].",
        inputSchema: {
            type: "object",
            properties: {
