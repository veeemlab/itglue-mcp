...
function documentResource(args, id) {
    ...
    const resource = { type: "documents", attributes };
    if (id)
        resource.id = id;
    return { data: resource };
}
function sectionResource(args, id) {
    const attributes = {};
    if (args.name !== undefined && args.name !== "")
        attributes.name = String(args.name);
    if (args.content !== undefined)
        attributes.content = String(args.content);
    ...
    const resource = { type: "document_sections", attributes };
    if (id)
        resource.id = id;
    return { data: resource };
}
export const documentTools = [
    ...
    },
    {
        ...
        handler: async (args, { client }) => {
            ...
            return client.get(`/documents/${encodeURIComponent(documentId)}/relationships/document_sections`, query);
        },
    },
    {
        ...
        handler: async (args, { client }) => {
            ...
            return client.post(`/documents/${encodeURIComponent(documentId)}/relationships/document_sections`, body);
        },
    },
    {
        ...
        handler: async (args, { client }) => {
            ...
            return client.patch(`/documents/${encodeURIComponent(documentId)}/relationships/document_sections/${encodeURIComponent(id)}`, body);
        },
    },
    {
