...
import { confirmSchema, paginationSchema, pickPagination, requireConfirm, requireId, requireString, toBoolOrUndef, toIntOrUndef, toStrOrUndef, } from "./shared.js";
function passwordResource(args, id) {
    ...
    const resource = { type: "passwords", attributes };
    if (id)
        resource.id = id;
...
export const passwordTools = [
    {
        ...
        description: "Search passwords. By default IT Glue returns metadata only; pass showPassword=true to include the password value in the response.",
        inputSchema: {
            type: "object",
            properties: {
                ...
                showPassword: {
                    type: "boolean",
                    description: "If true, include the plaintext password field (show_password=true). Requires confirm: \"SHOW_PASSWORD\".",
                },
                confirm: {
                    type: "string",
                    enum: ["SHOW_PASSWORD"],
        ...
        handler: async (args, { client }) => {
            if (args.showPassword === true)
                requireConfirm(args, "SHOW_PASSWORD");
    ...
    },
    {
        ...
        description: "Fetch one password. Pass showPassword=true to include the plaintext password value (requires confirm).",
        inputSchema: {
            type: "object",
            properties: {
                ...
                showPassword: {
                    type: "boolean",
                    description: "Include plaintext (show_password=true). Requires confirm: \"SHOW_PASSWORD\".",
                },
                confirm: {
                    type: "string",
                    enum: ["SHOW_PASSWORD"],
    ...
    },
    {
        ...
        description: 'Create a password entry. organizationId, name and password are required; username/url/notes are common optional fields. Sensitive write — requires confirm: "CREATE_PASSWORD".',
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: 'Update a password entry by id. Sensitive write — requires confirm: "UPDATE_PASSWORD".',
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: 'Delete a password entry by id. Destructive — requires confirm: "DELETE_PASSWORD".',
        inputSchema: {
            type: "object",
            properties: {
                id: { type: "string", description: "Password id." },
    ...
    },
    {
        ...
        handler: async (args, { client }) => {
            const query = mergeQuery(buildFilters({ name: toStrOrUndef(args.name) }), buildPagination(pickPagination(args)));
