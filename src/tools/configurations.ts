...
export const configurationTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    description:
      "List configuration type definitions — IT Glue's catalog of hardware/asset kinds like 'Laptop', 'Server', 'Workstation', 'Firewall', 'Switch', 'Printer', 'Mobile Device', 'Virtual Machine'. Returns type ids used as configurationTypeId when filtering search_configurations or creating new configurations. Synonyms: list config types, list device types, list asset types, list hardware categories.",
    inputSchema: {
      type: "object",
      properties: {
